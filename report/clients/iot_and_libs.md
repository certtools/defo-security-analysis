...
For instance, to use ECH in CPython, the current proposal involves [usage of low-level APIs](https://github.com/defo-project/ech-dev-utils/blob/e375acd0a1ee4b8abe4f89d60cac5af624931c77/scripts/ech_url.py#L84-L104).
However, for ECH to achieve widespread adoption, it needs to be accessible through high-level APIs, such as [httpx](https://www.python-httpx.org/), and be activated by default.

## Command Line Tools

The proposal for curl [requires DoH](https://github.com/sftcd/curl/blob/25f2c38/docs/ECH.md#user-content-supporting-ech-without-doh), similar to what Firefox implemented in the past.
...
Further work is necessary in this area, particularly by adding support for more tools, especially [wget](https://github.com/defo-project/ech-dev-utils/blob/475fc17/howtos/wget.md).
